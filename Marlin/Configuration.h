...
#define STRING_CONFIG_H_AUTHOR "hoblet.dev" // Who made the changes.
...
#if ENABLED(PIDTEMP)
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700  of PROGMEM)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 130 } // E5Pa
/**
 * Default Max Feed Rate (mm/s)
 * Override with M203
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 5000, 5000, 550, 2550 }
...
/**
 * Default Max  (change/s) change = mm/s
 * (Maximum start speed for accelerated moves)
 * Override with M201
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 5000, 15000 }
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { 42.39, 11.56, -3.05 } //E5Pa
#define NOZZLE_TO_PROBE_OFFSET {  48.5, 15, -3.05 } //E5Pb
...
//#define INVERT_E0_DIR true  //E5Pa
#define INVERT_E0_DIR false //E5Pb
...
//#define Y_BED_SIZE 220  // E5Pa
#define Y_BED_SIZE 500  // E5Pb
...
#define PREHEAT_2_TEMP_HOTEND 222
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 30   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
