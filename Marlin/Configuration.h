 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0456  // (mm) Distance from real junction edge
...
#define XY_PROBE_SPEED (80*60*60)
...
#define HOMING_FEEDRATE_XY (20*60*60)
#define HOMING_FEEDRATE_Z  (10*60*60)
